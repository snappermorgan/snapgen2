...
function snapgen_enqueue() {
	...
	wp_enqueue_script('snapgen_js', get_stylesheet_directory_uri() . '/js/vendor/jquery.easing.1.3.js', array( 'jquery' ));	
	wp_enqueue_script('snapgen_js', get_stylesheet_directory_uri() . '/js/vendor/jquery.scrollto.js', array( 'jquery' ));	
	wp_enqueue_script('snapgen_js', get_stylesheet_directory_uri() . '/js/vendor/bootstrap.js', array( 'jquery' ));	
