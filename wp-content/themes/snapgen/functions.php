...
function snapgen_enqueue() {
	...
	wp_enqueue_script('snapgen_js', get_stylesheet_directory_uri() . '/js/vendor/jquery.easing.1.3.js', array( 'jquery' ),'1.3',true);	
	wp_enqueue_script('snapgen_js', get_stylesheet_directory_uri() . '/js/vendor/jquery.scrollto.js', array( 'jquery' ),'1',true);	
	wp_enqueue_script('snapgen_js', get_stylesheet_directory_uri() . '/js/vendor/bootstrap.js', array( 'jquery' ),'1',true);	
