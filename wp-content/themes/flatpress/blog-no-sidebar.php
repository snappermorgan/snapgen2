 ...
 * Blog Template
 *
   Template Name: Blog - Full Width (no sidebar)
 *
 * @file           blog-no-sidebar.php
 * @package        FlatPress 
...
<?php if (have_posts()) : ?>
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="span7">
                <div class="post-edit"><?php edit_post_link(__('<button class="btn btn-mini btn-danger">Edit</button>', 'responsive')); ?></div> 
