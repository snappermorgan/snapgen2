...
function my_more_link( $more_link, $more_link_text ) {
    return str_replace( $more_link_text, '<p><a href="' . get_permalink() . '" class="btn">Read More </a> </p>', $more_link );
}
...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            ...
            'description' => __('Home 1 - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-1',
        ...
        register_sidebar(array(
            ...
            'description' => __('Home 2 - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-2',
        ...
        register_sidebar(array(
            ...
            'description' => __('Home 3 - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-3',
         ...
         register_sidebar(array(
            ...
            'description' => __('Home 4 - sidebar-home.php', 'responsive'),
            'id' => 'home-widget-4',
            'before_title' => '<div id="widget-title-three" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div id="%1$s" class="%2$s">',
        ...
        register_sidebar(array(
            ...
            'description' => __('Left Footer', 'responsive'),
            'id' => 'left-footer',
          ...
          register_sidebar(array(
            ...
            'description' => __('Right Footer', 'responsive'),
            'id' => 'right-footer',
            'before_title' => '<h3 class="footer-title">',
            'after_title' => '</h3>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
          ...
          register_sidebar(array(
            ...
            'description' => __('Contact - contact.php', 'responsive'),
            'id' => 'contact-widget',
            'before_title' => '<div id="widget-contact" class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="%2$s">',
            'after_widget' => '</div>'
        ));
...
?>
<?php 
function flat_pagination($pages = '', $range = 1)
{  
     $showitems = ($range * 2)+1;  
     ...
     if(1 != $pages)
     {
         ...
         if($paged > 1 && $showitems < $pages) echo "<li class='previous'><a href='".get_pagenum_link($paged - 1)."'><img src='".$imagepath."pager/previous.png' /></a></li>";
         ...
         if ($paged < $pages && $showitems < $pages) echo "<li class='next'><a href='".get_pagenum_link($paged + 1)."'><img src='".$imagepath."pager/next.png' /></a></li>";  
