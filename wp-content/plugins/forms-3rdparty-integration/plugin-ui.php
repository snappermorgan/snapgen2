		...
		<div class="shortcode-description postbox">
			...
			<fieldset><legend><span>Service</span></legend>
				<div class="inside">
					...
					<div class="field">
						...
						<input id="hook-<?php echo $eid?>" type="hidden" name="<?php echo $P?>[<?php echo $eid?>][hook]" value="true" />
			...
			<fieldset><legend><span>Mapping</span></legend>
				...
				* Note that the label is just for you to remind yourself what the mapping is for, and does not do anything.  <br />
				...
				<hr>
				<div class="postbox tokens">
				<h3 class="inner actn"><span>[+]</span><span><?php _e('Field Tokens', 'service') ?></span></h3>
				<div class="description-body inside">
				<div class="description">
				
				<p>The following tokens represent the form fields for each Form. Use them in the above mapping table.</p> 
				
				<script type="text/javascript">
				jQuery.each(form_fields_json,function(i,o){
					document.write('<div class="postbox form-fields"><h3 class="inner actn"><span>[+]</span><span>'+o.title+'</span></h3><div class="description-body inside"><div class="description"><ul>');
					jQuery.each(o.form_object.fields,function(a,b){
						document.write("<li><span class='field-label'>"+b.label+"</span> : <span class='field-id'>"+ b.id+"</span><button class='copy-button' data-clipboard-text='"+b.id+"' onclick='return false;' title='Click to copy Field ID.'>Copy</button></li>");
			...
			<span class="button"><a href="#" class="actn" data-actn="duplicate" data-after="metabox" data-rel="div.meta-box">Duplicate this Service</a></span>
