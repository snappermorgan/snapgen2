<?php
final class CRED_Generic_Fields_Controller extends CRED_Abstract_Controller
{
    public function getField($get,$post)
    {
        ...
        if (isset($get['field']) && ($get['field']!='conditional_group'))
        {
            ...
            echo CRED_Loader::tpl('generic-field-shortcode-setup',array(
        ...
        {
            echo CRED_Loader::tpl('conditional-shortcode-setup',array(
                //'fields'=>$fields,
                'help'=>CRED_CRED::$help,
                'help_target'=>CRED_CRED::$help_link_target
            ));
    ...
    public function getCustomField($get,$post)
    {
        ...
        if (isset($get['field_name']))
        {
            ...
            echo CRED_Loader::tpl('custom-field-setup',array(
                'field'=>$fields[$field_type],
                'data'=>$data,
                'popup_close'=>$popup_close,
                'field_name'=>$field_name,
                'post_type'=>$post_type,
                'url'=>CRED_CRED::route('/Generic_Fields/getCustomField?post_type='.$post_type.'&field_name='.$field_name),
                'fields'=>$fields
            ));
        }
        die();
