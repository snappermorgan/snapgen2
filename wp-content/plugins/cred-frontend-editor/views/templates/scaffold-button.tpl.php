...
<span id="cred-scaffold-button" class="cred-media-button">
    <a href='javascript:;' id="cred-scaffold-button-button" class='cred-button' title='<?php echo esc_attr(__('Auto-Generate Form','wp-cred')); ?>'><?php _e('Auto-Generate Form','wp-cred'); ?></a>
