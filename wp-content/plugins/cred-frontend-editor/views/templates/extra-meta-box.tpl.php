...
<a class='cred-help-link' style='position:absolute;top:5px;right:10px' href='<?php echo $help['css_settings']['link']; ?>' target='<?php echo $help_target; ?>' title="<?php echo esc_attr($help['css_settings']['text']); ?>">
