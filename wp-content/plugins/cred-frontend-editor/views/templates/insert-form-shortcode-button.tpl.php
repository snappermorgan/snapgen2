...
<span id="cred-form-shortcode-button" class="cred-media-button">
    ...
    <a href='javascript:;' id="cred-form-shortcode-button-button" class='cred-icon-button' title='<?php echo esc_attr(__('Insert Forms','wp-cred')); ?>'></a>
                ...
                <div id='cred-post-delete-link-container-advanced' class='cred-shortcodes-container-advanced'>
                    ...
                    <table class='cred-table' cellpadding=0 cellspacing=0>
                        ...
                        <tr>
                            ...
                            <td><input  type='text' id='cred-delete-html-message' name='cred-delete-html-message' value='' /></td>
                        </tr>
                    </table>
                    </fieldset>
                </div>
