...
<span class="cred-media-button cred-form-shortcode-button2">
    <?php if( ( isset($_GET['page']) && ( $_GET['page'] == 'views-editor' || $_GET['page'] == 'view-archives-editor' ) ) || defined('CT_INLINE') ) {?>
        <button class="js-code-editor-toolbar-button js-code-editor-toolbar-button-cred-icon button-secondary">
            <i class="icon-cred"></i><span class="button-label"><?php echo esc_attr(__('CRED forms','wp-cred')); ?></span></button>
    <?php } else{?>
    <a href='javascript:;' class='cred-icon-button cred-form-shortcode-button-button2' title='<?php echo esc_attr(__('Insert Forms','wp-cred')); ?>'></a>
    <?php }?>
