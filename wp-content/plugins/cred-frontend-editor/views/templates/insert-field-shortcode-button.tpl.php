...
<span id="cred-shortcode-button" class="cred-media-button">
    <a href='javascript:;' id="cred-shortcode-button-button" class='cred-button' title='<?php echo esc_attr(__('Insert Post Fields','wp-cred')); ?>'><?php _e('Insert Post Fields','wp-cred'); ?></a>
