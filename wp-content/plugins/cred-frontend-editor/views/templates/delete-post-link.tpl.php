...
function _cred_cred_delete_post_handler(__isFromLink__, __link__, __url__, __result__, __message__)
{
    var __ltext__='';
    ...
    else // callback from iframe return function
    {
        ...
        {
            alert('<?php echo esc_js(__('Post deleted','wp-cred')); ?>');
...
<a href='<?php echo $link; ?>' <?php if ($link_atts!==false) echo $link_atts; ?> id='<?php echo $link_id; ?>' target='<?php echo $iframehandle; ?>' onclick='return _cred_cred_delete_post_handler(true, this, false, false, "<?php echo esc_js($message); ?>");'><?php echo $text; ?></a>