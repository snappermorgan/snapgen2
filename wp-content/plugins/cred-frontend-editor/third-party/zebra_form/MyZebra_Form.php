...
class MyZebra_Form
{
    ...
    function render($template = '', $return = false, $variables = '')
    {
        ...
        $output .= '<div class="myzebra-form-hidden" style="display:none;">';
...
if ( window.jQuery )
{
    /* on DOM ready */
    jQuery(function(){
        jQuery("#<?php echo $this->form_properties['name']; ?>").MyZebra_Form({<?php echo $javascript_object_properties; ?>}); 
        <?php echo $control_js; ?>
    });
}
/* ]]> */
        ...
        foreach ($this->conditionals as $id=>$conditional)
        {
            ...
            foreach ($vars as $key=>$vv)
            {
                ...
                if (
                    ...
                    $field->attributes['type']=='multiselect') &&
