                    ...
                    switch ($rule_name) {
                        ...
                        case 'filetype':
                            ...
                            if (
                                ...
                                // this is removed, as file types as added to the control only should be checked
                                ...
                                // determine mime same as WP does, by extension
                                $ext_preg = '!\.(.+)$!i';
                                if ( preg_match( $ext_preg, $this->file_data[$attribute['name']]['name'], $ext_matches ) ) {
                                    $mime = $ext_matches[1];
                                }
                                else $mime=false;
                                // if file is not allowed
                                if (/*empty($matches)*/ !in_array($mime, $allowed_file_types)) {
