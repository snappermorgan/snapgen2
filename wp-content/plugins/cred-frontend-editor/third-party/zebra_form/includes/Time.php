 ...
 *  @package    Controls
 */
class MyZebra_Form_Time extends MyZebra_Form_Control
{
    ...
    function MyZebra_Form_Time($id, $default = '', $attributes = '')
    {
        ...
        $this->set_attributes(
            ...
            array(
                ...
                'id'        =>  preg_replace('/\[.*\]$/', '', $id),
                'value'     =>  $default,
                'class'     =>  'myzebra-control myzebra-time',
                'format'    =>  'hm',
                'hours'     =>  $hours,
                'minutes'   =>  $minutes,
                'seconds'   =>  $seconds,
    ...
    function _toHTML()
    {
        ...
        $attributes = $this->get_attributes(array('name', 'id', 'value', 'class', 'format', 'hours', 'minutes', 'seconds'));
        ...
        if ($hour_position !== false) {
            ...
            $output .= '
                <select name="' . $attributes['name'] . '_hours" id="' . $attributes['id'] . '_hours" class="' . $attributes['class'] . '">
                    <option value="">-</option>';
        ...
        if ($minutes_position !== false) {
            ...
            $output .= '
                <select name="' . $attributes['name'] . '_minutes" id="' . $attributes['id'] . '_minutes" class="' . $attributes['class'] . '">
                    <option value="">-</option>';
        ...
        if ($seconds_position !== false) {
            ...
            $output .= '
                <select name="' . $attributes['name'] . '_seconds" id="' . $attributes['id'] . '_seconds" class="' . $attributes['class'] . '">
                    <option value="">-</option>';
        ...
        if (isset($ampm)) {
            ...
            $output .= '
                <select name="' . $attributes['name'] . '_ampm" id="' . $attributes['id'] . '_ampm" class="' . $attributes['class'] . '">
                    <option value="">-</option>';
        ...
        $output .= '<div class="myzebra-clear"></div>';
