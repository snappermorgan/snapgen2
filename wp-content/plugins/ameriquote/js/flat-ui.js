    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            var $dropdown = this.dropdown,
                ...
                dropTop = (offset.top + height)-$("#ameriquote_wrapper").offset().top,
        ...
        opening: function() {
            ...
            if(this.dropdown[0] !== $("#ameriquote_wrapper").children().last()[0]) {
                this.dropdown.detach().appendTo($("#ameriquote_wrapper"));
            }
            ...
            if (mask.length == 0) {
                ...
                mask.hide();
                mask.appendTo($("#ameriquote_wrapper"));
