...
Description: This is a Plugin Helper to allow you to easily setup an External API on Gravity Form Submissions.
Version: 1.0.1
*/
		...
		if(!empty($custom_apis))
		{
			foreach ($custom_apis as $api)
			{
				...
				foreach($form['fields'] as $field)
				{
					...
					if(!empty($field['ggah_'.str_replace('-', '_', $api).'_field']) && !empty($field['id']) && isset($value))
					{
