...
function wpv_ct_loader_inline_callback() {
    ...
    ?>
        ...
        <script type="text/javascript">            
            // TODO IMPORTANT
			// Review how this is being done, I do not like to have third party globals being checked this way at all
            if ( typeof DDLayout !== 'undefined' && DDLayout.content_template_cell ){
               var wpv_inline_editor_qt = quicktags("wpv-ct-inline-editor-<?php echo $ct_id; ?>");
               DDLayout.content_template_cell.add_quicktags(wpv_inline_editor_qt); 
            }            
        </script>
