	...
	*/
	...
	function wpv_admin_enqueue_scripts($hook) {// echo $hook; TODO this function needs a lot of love
		...
		*/
		...
		wp_register_script( 'views-redesign-js', ( WPV_URL . "/res/js/redesign/views_editor.js" ), array( 'jquery','wp-pointer', 'jquery-ui-sortable', 'jquery-ui-draggable', 'views-codemirror-script', 'underscore', 'views-utils-script'), WPV_VERSION, true );
		...
		wp_register_script( 'views-archive-redesign-js', ( WPV_URL . "/res/js/redesign/views_archive_editor.js" ), array( 'jquery','wp-pointer', 'jquery-ui-sortable', 'jquery-ui-draggable', 'views-codemirror-script', 'underscore', 'views-utils-script'), WPV_VERSION, true );
		...
		*/
		...
		if ( isset( $_GET['page'] ) && $_GET['page'] == 'views-editor' ) {
			...
			wp_localize_script( 'views-redesign-filters-js', 'wpv_filters_strings', $filters_strings );
			...
			wp_localize_script( 'views-redesign-parent-js', 'wpv_parent_strings', $parent_strings );
			...
			wp_localize_script( 'views-redesign-post-relationship-js', 'wpv_pr_strings', $pr_strings );
