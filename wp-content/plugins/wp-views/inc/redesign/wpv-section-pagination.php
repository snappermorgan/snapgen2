...
function add_view_pagination($view_settings, $view_id) { //TODO review that default values are set before we display any of this
	...
	<div class="wpv-setting-container wpv-settings-pagination js-wpv-settings-pagination<?php echo $hide; ?>">
						...
						<li>
							...
							<ul>
								<li>
									...
									<ul id="wpv-spinner-default" class="wpv-spinner-selection js-wpv-pagination-spinner-default">
										<?php
										...
										<li>
											<label>
												<input type="radio" name="pagination[spinner_image]" value="<?php echo $filename; ?>"<?php if ( $spinner_image == $filename || $spinner_image == $filename2) { echo ' checked="checked"'; } ?> autocomplete="off" />
		...
		<span class="update-button-wrap auto-update">
