		...
		<form id="js-parametric-form" >
			...
			<!--	<legend id="js_legend_default"><?php _e('Defaults', 'wpv-views');?></legend> -->
				...
				<p data-bind="visible:fieldRaw">
					...
					<span class="helper-text"><?php _e( 'You can use any of those form elements.', 'wpv-views' ); ?></span>
				</p>
				...
				<div data-bind="visible:fieldRaw">
					...
					<div data-bind="visible:ancestors_visible">
						...
						<span class="helper-text"><?php _e( 'Select which ancestors should be part of this filter.', 'wpv-views' ); ?></span>
					</div>
					...
					<p data-bind="visible:default_label_visible">
							...
							<span class="helper-text"><?php _e( 'Besides the list of terms, an additional option will show to not select any term.', 'wpv-views' ); ?></span>
							<span class="helper-text"><?php _e( 'Choose the label for that option.', 'wpv-views' ); ?></span>
					</p>
				...
				<div id="format_attribute" data-bind="visible: show_values_settings() || taxonomy_order_visible() || ancestors_visible() ">
					<p>
						...
						<span class="helper-text"><?php _e( 'By default, the names of the items will be displayed.', 'wpv-views' ); ?></span>
						<span class="helper-text"><?php _e( 'You can edit and add your text and the count of posts in each item.', 'wpv-views' ); ?></span>
						<span class="helper-text"><?php _e( 'You can use %%NAME%% and %%COUNT%% as placeholders', 'wpv-views' ); ?></span>
					</p>
				</div>
				...
				<div id="comparison_function" data-bind="visible: fieldRaw ">
					<p>
						...
						<!--<span class="helper-text">IN - results match to search</span>
						<span class="helper-text">NOT IN - results don’t match the search</span>
						<span class="helper-text">AND - What does this actually do ????</span>-->
					</p>
				</div>
				...
				<div class="hidden js-hidden-fields-container">
					...
					<div data-bind="foreach:url_param">
						<p>
							...
							<span class="helper-text"><?php _e( 'This is the URL parameter that will be used to post the filter values.', 'wpv-views' ); ?></span>
						</p>
					</div>
					<p>
						...
						<span class="helper-text"><?php _e( 'Compare the posted values with the existing ones as this type of data.', 'wpv-views' ); ?></span>
					</p>
				</div>
