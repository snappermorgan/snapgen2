		...
		wp_register_script('wpv-parametric-admin-script' , WPV_URL . '/res/js/redesign/views_parametric.js', array('jquery', 'icl_editor-script', 'views-codemirror-script'), WPV_VERSION);
    		...
    		wp_localize_script( 'wpv-parametric-admin-script',
    							...
    							array(
									...
									'add_toolbar_submit_button_title' => __( 'Use the submit button to get rsults based on the form values', 'wpv-views' ),
									'add_toolbar_submit_button_title_complete' => __( 'This element was already added', 'wpv-views' ),
									'add_toolbar_submit_button_title_incomplete' => __( 'You need to add this element', 'wpv-views' ),
									'add_toolbar_submit_button_title_irrelevant' => __( 'You do not need this element', 'wpv-views' ),
									'add_toolbar_submit_button_title_irrelevant_added' => __( 'You do not need this element but you already have it', 'wpv-views' ),
									...
									'add_toolbar_reset_button_title_complete' => __( 'This element was already added', 'wpv-views' ),
									'add_toolbar_reset_button_title_incomplete' => __( 'You can add this element', 'wpv-views' ),
									...
									'add_toolbar_spinner_button_title_complete' => __( 'This element was already added', 'wpv-views' ),
									...
									'add_toolbar_search_button_title' => __( 'This is used to add a search box', 'wpv-views' ),
									'add_toolbar_search_button_title_complete' => __( 'This element was already added', 'wpv-views' ),
									'add_toolbar_search_button_title_missing' => __( 'You have the shortcode but not the filter', 'wpv-views' ),
