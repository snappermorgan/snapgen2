	...
	static function wpv_render_post_search_options( $view_settings = array() ) {
		...
		<ul class="wpv-filter-options-set">
			<li>
				...
				<input type="radio" id="wpv-search-mode-specific" name="search_mode[]" value="specific" <?php echo $checked; ?> />
			...
			<li>
				...
				<input type="radio" id="wpv-search-mode-manual" name="search_mode[]" value="manual" <?php echo $checked; ?> />
