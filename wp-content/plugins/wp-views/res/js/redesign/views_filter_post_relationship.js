...
WPViews.PostRelationshipFilterGUI = function( $ ) {
	...
	// @todo watch out! it is cleared when opening the edit fast after save, seems to eb because the show/hide of the success message!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	self.show_hide_post_relationship_notice = function() {
		...
		if ( show ) {
			...
			$( self.post_options_container_selector ).wpvToolsetMessage({
				text:rel_message,
				type:'error',
